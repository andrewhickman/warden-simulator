...
fn handle_tile_placement(
    ...
    match *mode {
        ...
        TilePlacementMode::StairN => {
            commands.spawn_tile(tile_pos, Stair::NORTH, Stair::North);
        }
        TilePlacementMode::StairS => {
            commands.spawn_tile(tile_pos, Stair::SOUTH, Stair::South);
        }
        TilePlacementMode::StairE => {
            commands.spawn_tile(tile_pos, Stair::EAST, Stair::East);
        }
        TilePlacementMode::StairW => {
            commands.spawn_tile(tile_pos, Stair::WEST, Stair::West);
        }
    }
}

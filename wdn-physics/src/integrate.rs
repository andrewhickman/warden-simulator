...
mod tests {
    ...
    fn integrate_wall_collision_active() {
        ...
        assert_relative_eq!(velocity.get(), Vec2::new(0.0, 3.0));
    ...
    fn integrate_wall_collision() {
        ...
        let velocity = app.world().get::<Velocity>(entity).unwrap();
        assert_relative_eq!(velocity.get(), Vec2::new(4.0, 0.0));
    ...
    fn integrate_multiple_collisions() {
        ...
        let velocity = app.world().get::<Velocity>(entity).unwrap();
        assert_relative_eq!(velocity.get(), Vec2::ZERO);
    ...
    fn integrate_wall_collision_receding() {
        ...
        let velocity = app.world().get::<Velocity>(entity).unwrap();
        assert_relative_eq!(velocity.get(), Vec2::new(5.0, 3.0));
    ...
    fn integrate_collider_collision() {
        ...
        let velocity = app.world().get::<Velocity>(entity).unwrap();
        assert_relative_eq!(velocity.get(), Vec2::new(-1.0, 1.0), epsilon = 1e-4);
    ...
    fn integrate_non_solid_collision_active() {
        ...
        let velocity = app.world().get::<Velocity>(entity).unwrap();
        assert_relative_eq!(velocity.get(), Vec2::new(4.0, 2.0));
    ...
    fn integrate_non_solid_wall_collision_active() {
        ...
        let velocity = app.world().get::<Velocity>(entity).unwrap();
        assert_relative_eq!(velocity.get(), Vec2::new(3.0, -5.0));

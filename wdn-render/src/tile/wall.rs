...
fn resolve_top(
    ...
    match (center, east, south_east, south) {
        ...
        (StairE | Wall, Door | Empty | StairE | StairN, _, StairE)
        | (StairE, StairS | StairW | Wall, _, StairE) => TOP_EMPTY_SOUTHSTAIREFULL,
        ...
        (Wall, StairS, _, StairE) => TOP_WALLCORNER_SOUTHSTAIREFULL_EASTSTAIRS,
